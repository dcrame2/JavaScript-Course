...
const account2 = {
  ...
  movementsDates: [
    ...
    '2022-08-4T18:49:59.371Z',
    '2022-08-6T12:01:20.894Z',
  ],
  currency: 'USD',
  locale: 'en-US',
};
...
// // function that takes two dates and returns the other days
// const calcDaysPassed = (date1, date2) =>
//   Math.abs(date2 - date1) / (1000 * 60 * 60 * 24);
// console.log(calcDaysPassed(new Date(2037, 3, 14), new Date(2037, 3, 24)));

//Formatting numbers for international individuals (highly interesting)
// const num = 16516151;
...
if (ingredients.includes('carrot')) clearTimeout(pizzaTimer);
